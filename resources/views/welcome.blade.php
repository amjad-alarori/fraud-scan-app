...
@section('content')
    ...
    <div class="grid grid-cols-2 gap-4">
        <button class="bg-gradient-to-br from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-bold py-8 px-8 rounded-full transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110" onclick="location.href='{{ url('customers') }}'">            Scan Customers
        </button>
